...
send_daily_report() {
    ...
    message="${message}   Ratio: ${ratio}x ${status_emoji}\n\n"
    ...
    message="${message}   Day ${days_since_reset} / $((days_since_reset + days_until_reset))\n"
    message="${message}   Resets in ${days_until_reset} day(s) (${reset_day}th of month)"
